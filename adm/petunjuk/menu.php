			...
			<ul class="nav pull-left">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="icon-info-sign"></span><b> Kelola </b><b class="caret"></b></a>
					<ul class="dropdown-menu">
						...
						<li><a href="pakar.php?hal=1"><span class="icon-info-sign"></span><b> Basis Pengetahuan</b></a></li>
					...
					<ul class="dropdown-menu">
						<li><a href="informasi.broiler.php?hal=1"><span class="icon-info-sign"></span><b> Tentang Ayam Pedaging</b></a></li>
						<li><a href="informasi.petelur.php?hal=1"><span class="icon-info-sign"></span><b> Tentang Ayam Petelur</b></a></li>
						<li><a href="harga.pakan.php?hal=1"><span class="icon-info-sign"></span><b> Harga Pakan</b></a></li>
                        
					</ul>
				</li>
                <li><a href="hasil.konsultasi.php?hal=1"><span class="icon-info-sign"></span><b> Hasil Konsultasi</b></a></li>
				</li>
				...
				<li><a href="admin.php"><span class="icon-info-sign"></span><b> Admin</b></a></li>
				<li><a href="petunjuk/index.php"><span class="icon-info-sign"></span><b> Petunjuk Teknis</b></a></li>
			</ul>
