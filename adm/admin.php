<?php
	...
	$jml_data = mysqli_num_rows($conn->query("select * from admin"));
	...
	if(isset($_GET['hal'])){
			...
			$s = $conn->query("select * from admin order by id_user desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = $conn->query("select * from admin order by id_user desc limit 0, $jml_per_halaman")
				or die(mysqli_error());
	}
?>
			...
			<div>
                ...
                <div style="margin-top:10px">
                    ...
                    <thead>
                        ...
                        <td width="20%"><font face="Comic Sans MS, cursive" class="text-error text-center"><h5>Email</h5></font></td>
                        <td width="30%"><font face="Comic Sans MS, cursive" class="text-error text-center"><h5>Level</h5></font></td>
                    ...
                    <tbody>
                        ...
                        <td><font face="Comic Sans MS, cursive" class="text-info text-center"><h5><?php echo "$level";?></h5></font></td>
                        <td>
