<?php
	...
	$kode	= $_GET['kode'];
	$sql	= $conn->query("select * from gejala where kode_gejala='$kode'");
            ...
            <div style="margin-top:10px;">
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                        	<input name="bobot" type="text" id="nama" class="input-xxlarge" value='<?php echo "$bobot";?>'>
                        </div>
                    </div>
                    ...
                    <?php }
						if(isset($_POST['update'])){
							$conn->query("update gejala set
											kode_gejala= '$_POST[kode]',
											nama_gejala= '$_POST[nama]',
											bobot= '$_POST[bobot]'
											
											where kode_gejala='$kode'") or die(mysqli_error);
