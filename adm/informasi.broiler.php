<?php
	...
	$jml_data = mysqli_num_rows($conn->query("select * from artikel_pedaging"));
	...
	if(isset($_GET['hal'])){
			...
			$s = $conn->query("select * from artikel_pedaging order by id_informasi desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = $conn->query("select * from artikel_pedaging order by id_informasi desc limit 0, $jml_per_halaman")
				or die(mysqli_error());
	}
?>
...
<head>
	<meta charset="utf-8">
	<title>Artikel Ayam Pedaging</title>
        ...
        <div class="navbar-inner" style="border:1px solid #bbb; border-radius:10px; padding:10px 20px 10px 20px; margin-top:50px; margin-left:auto; margin-right:auto;">
			<div>
            	...
            	<div style="margin-top:10px" class="text-right">
            		<a href="informasi.broiler.add.php"><input name="tambah" type="submit" id="tambah" value="Tambah Data" class="btn btn-danger"></a>
                </div>
                <div style="margin-top:10px">
                    ...
                    <thead>
                        ...
                        <td width="15%"><font face="Comic Sans MS, cursive" class="text-error text-center"><h5>Kategori</h5></font></td>
                        ...
                        <td width="5%"><font face="Comic Sans MS, cursive" class="text-error text-center"><h5>Keterangan</h5></font></td>
                    ...
                    <tbody>
                        ...
                        <td><font face="Comic Sans MS, cursive" class="text-error text-center"><h5><?php echo "$kategori";?></h5></font></td>
                        ...
                        <td>
                        	<font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
                                <a class="tip" href="informasi.broiler.update.php?id=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                                    title="Edit"><span class="icon-pencil"></span></a>
                                <a class="tip" href="informasi.broiler.delete.php?id=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="pagination pagination-centered">
                        <ul>
                            <?php for($i = 1; $i <= $jml_halaman; $i++) { ?>
                                <li><a href="informasi.broiler.php?hal=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
