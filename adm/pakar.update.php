<?php
	...
	$kode = $_GET['kode'];
	$sql	= $conn->query("select * from kasus where kode_penyakit='$kode'");
            	...
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                    ...
                    <?php }
						if(isset($_POST['simpan'])){
							$conn->query("delete from kasus where kode_penyakit='$kode'") or die(mysqli_error());
							...
							for($i=0; $i < $jumlah; $i++){
								...
								$q=$conn->query("insert into kasus(kode_penyakit, id_gejala) values ('$_POST[kode_penyakit]', '$gejala')") or die(mysqli_error());
							}
