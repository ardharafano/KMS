<?php
	...
	$jml_data = mysqli_num_rows($conn->query("select * from artikel_petelur"));
	...
	if(isset($_GET['hal'])){
			...
			$s = $conn->query("select * from artikel_petelur order by id_informasi desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = $conn->query("select * from artikel_petelur order by id_informasi desc limit 0, $jml_per_halaman")
				or die(mysqli_error());
	}
?>
...
<head>
	<meta charset="utf-8">
	<title>Informasi Ayam Petelur</title>
        ...
        <div class="navbar-inner" style="border:1px solid #bbb; border-radius:10px; padding:10px 20px 10px 20px; margin-top:50px; margin-left:auto; margin-right:auto;">
			<div>
            	...
            	<div style="margin-top:10px" class="text-right">
            		<a href="informasi.petelur.add.php"><input name="tambah" type="submit" id="tambah" value="Tambah Data" class="btn btn-danger"></a>
                </div>
                    ...
                    <tbody>
                        ...
                        <td>
                        	<font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
                                <a class="tip" href="informasi.petelur.update.php?id=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                                    title="Edit"><span class="icon-pencil"></span></a>
                                <a class="tip" href="informasi.petelur.delete.php?id=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="pagination pagination-centered">
                        <ul>
                            <?php for($i = 1; $i <= $jml_halaman; $i++) { ?>
                                <li><a href="informasi.petelur.php?hal=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
