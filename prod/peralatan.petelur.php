<?php
	...
	$jml_data = mysqli_num_rows($conn->query("select * from peralatan_petelur"));
	...
	if(isset($_GET['hal'])){
			...
			$s = $conn->query("select * from peralatan_petelur order by id_informasi desc limit ".(($hal - 1) * $jml_per_halaman).", $jml_per_halaman");
		
	}else{
		$s = $conn->query("select * from peralatan_petelur order by id_informasi desc limit 0, $jml_per_halaman")
				or die(mysqli_error());
	}
?>
...
<body>
  <div class="container container-body">
			...
			<li><a href="informasi.petelur.php?hal=1"><b>Tentang Ayam Petelur</b></a></li>
			<li><a href="peralatan.petelur.php?hal=1"><b>Peralatan & Perkandangan</b></a></li>
        ...
        <div class="navbar-inner" style="border:1px solid #bbb; border-radius:10px; padding:10px 20px 10px 20px; margin-top:50px; margin-left:auto; margin-right:auto;">
			<div>
            	...
            	<div style="margin-top:10px" class="text-right">
            		<a href="peralatan.petelur.add.php"><input name="tambah" type="submit" id="tambah" value="Tambah Data" class="btn btn-danger"></a>
                </div>
                    ...
                    <tbody>
                        ...
                        <td>
                        	<font face="Comic Sans MS, cursive" class="text-info text-center"><h5>
                                <a class="tip" href="peralatan.petelur.update.php?inf=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                                    title="Edit"><span class="icon-pencil"></span></a>
                                <a class="tip" href="peralatan.petelur..delete.php?inf=<?php echo $id;?>" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="pagination pagination-centered">
                        <ul>
                            <?php for($i = 1; $i <= $jml_halaman; $i++) { ?>
                                <li><a href="peralatan.petelur.php?hal=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
