...
<form class="form-horizontal" name="login" id="form-login" method="post" action="log_proc.php" onSubmit="return validasi(this)">
	<div class="modal-body text-center">
		...
		<br>
		<a href="../prod/index.php" data-toggle="tooltip" title="Hubungi Kami" class="btn btn-info" role="button"><span class="glyphicon glyphicon-list"></span> Login Sebagai Production</a></center>
				<br><br>
		<div>
			<a href="../wh/index.php" data-toggle="tooltip" title="Hubungi Kami" class="btn btn-info" role="button"><span class="glyphicon glyphicon-list"></span> Login Sebagai Warehouse</a></center>
		</div> 
	</div>
</form>