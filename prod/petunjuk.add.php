            	...
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                      ...
                      <label class="control-label" for="kategori">Kategori</label>
                        <div class="controls">
                            <select class="form-control" name="kategori">
                                <option value="Kelola Gejala">Kelola Gejala</option>
                                <option value="Kelola Penyakit">Kelola Penyakit</option>
								<option value="Kelola Basis Pengetahuan">Kelola Basis Pengetahuan</option>
                                <option value="Kelola Artikel">Kelola Artikel</option>
                                <option value="Kelola Dokumen">Kelola Dokumen</option>
                                <option value="Kelola Admin">Kelola Admin</option>
                                <option value="Melihat Hasil Konsultasi">Melihat Hasil Konsultasi</option>
                            </select>
                        </div>
						</div>
                    <div>
                    ...
                    <?php
						if(isset($_POST['simpan'])){
							$conn->query("insert into petunjuk_teknis (judul, kategori, isi, tgl, ket) values ('$_POST[judul]', '$_POST[kategori]', '$_POST[isi]', NOW(), '$_POST[ket]')")
							or die(mysqli_error);
