<?php
	...
	$kode	= $_GET['kode'];
	$sql	= $conn->query("select * from penyakit where kode_penyakit='$kode'");
            ...
            <div style="margin-top:10px;">
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
						...
						<div>
                     <label class="kotak" for="keterangan">Keterangan</label>
                        <div class="controls">
                        	<textarea name="ket" class="ckeditor" id="ket"><?php echo "$ket";?></textarea>
                        </div>
                    </div>
						<div>
                     <label class="kotak" for="solusi">Solusi</label>
                        <div class="controls">
                        	<textarea name="solusi" class="ckeditor" id="solusi"><?php echo "$solusi";?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <?php }
						if(isset($_POST['update'])){
							$conn->query("update penyakit set
