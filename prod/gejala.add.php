            ...
            <div style="margin-top:10px;">
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                        	<input name="bobot" type="text" id="nama" class="input-xxlarge">
                        </div>
                    </div>
                    ...
                    <?php
						if(isset($_POST['simpan'])){
							$conn->query("insert into gejala (kode_gejala, nama_gejala, bobot) values ('$_POST[kode]', '$_POST[nama]', '$_POST[bobot]')")
							or die(mysqli_error);
