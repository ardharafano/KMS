			...
			<div>
                ...
                <div style="margin-top:20px">
                    ...
                    <?php
						...
						<?php
                        //PROSES PENYAKIT P01
                        $s1 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P01%') AND konsultasi=$konsultasi");
						...
						$ssum1 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j1
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P01%')") or die(mysqli_error());
                        ...
                        //PROSES PENYAKIT P02
                        $s2 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P02%') AND konsultasi=$konsultasi");
                        ...
                        $ssum2 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j2
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P02%')") or die(mysqli_error());
                        
						$dsum2 = mysqli_fetch_array($ssum2);
						echo "<br>a = Jumlah Bobot Untuk Penyakit P02 = $dsum2[j2]";
						
                        $proses2 = $dsum2['j2']/16;
                        echo "<br>b = Total Bobot Pada P02 = 16";
						echo "<br>Rumus Similarity P02 : a/b";
						echo "<br>Similarity P02 = ".$proses2;
						echo "<br><br>";
                        
                        //PROSES PENYAKIT P03
                        $s3 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P03%') AND konsultasi=$konsultasi");
						...
						$ssum3 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j3
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P03%')") or die(mysqli_error());
                        ...
                        //PROSES PENYAKIT P04
                        $s4 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P04%') AND konsultasi=$konsultasi");
                        ...
                        $ssum4 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j4
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P04%')") or die(mysqli_error());
                        ...
                        //PROSES PENYAKIT P05
                        $s5 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P05%') AND konsultasi=$konsultasi");
                        ...
                        $ssum5 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j5
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P05%')") or die(mysqli_error());
                        ...
                        //PROSES PENYAKIT P06
                        $s6 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P06%') AND konsultasi=$konsultasi");
                        ...
                        //PROSES PENYAKIT P07
                        $s7 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P07%') AND konsultasi=$konsultasi");
                        ...
                        $ssum7 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j7
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P07%')") or die(mysqli_error());
                        ...
                        //PROSES PENYAKIT P08
                        $s8 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P08%') AND konsultasi=$konsultasi");
                        ...
                        $ssum8 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j8
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P08%')") or die(mysqli_error());
						...
						//PROSES PENYAKIT P09
                        $s9 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P09%') AND konsultasi=$konsultasi");
                        ...
                        $ssum9 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j9
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P09%')") or die(mysqli_error());
						...
						//PROSES PENYAKIT P10
                        $s10 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P10%') AND konsultasi=$konsultasi");
                        ...
                        $ssum10 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j10
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P010%')") or die(mysqli_error());
                        $dsum10 = mysqli_fetch_array($ssum10);
						echo "<br>a = Jumlah Bobot Untuk Penyakit P08 = $dsum8[j10]";
						...
						//PROSES PENYAKIT P11
                        $s11 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P11%') AND konsultasi=$konsultasi");
                        ...
                        $ssum11 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j11
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P11%')") or die(mysqli_error());
                        $dsum11 = mysqli_fetch_array($ssum11);
						echo "<br>a = Jumlah Bobot Untuk Penyakit P11 = $dsum8[j11]";
						...
						//PROSES PENYAKIT P12
                        $s12 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P12%') AND konsultasi=$konsultasi");
                        ...
                        $ssum12 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j12
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P012%')") or die(mysqli_error());
                        $dsum12 = mysqli_fetch_array($ssum12);
						echo "<br>a = Jumlah Bobot Untuk Penyakit P12 = $dsum8[j12]";
						
                        $proses12 = $dsum12['j12']/9;
						echo "<br>b = Total Bobot Pada P12 = 9";
						echo "<br>Rumus Similarity P12 : a/b";
						echo "<br>Similarity P12 = ".$proses11;
						echo "<br><br>";
						
						//PROSES PENYAKIT P013
                        $s13 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P13%') AND konsultasi=$konsultasi");
                        $r13 = mysqli_num_rows($s13);
                        
						echo "<br><br>";
						echo "<hr>";
						echo "Data Ditemukan ".$r12." Gejala Yang Sama Pada Penyakit P13, Yaitu :";
						echo "<br>";
						
						while($d13 = mysqli_fetch_array($s13)){
							if($r13>0){
								$sg13 = $conn->query("select * from gejala where id_gejala='$d12[id_gejala]'") or die(mysqli_error());
                        ...
                        $ssum13 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j13
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P13%')") or die(mysqli_error());
                        $dsum13 = mysqli_fetch_array($ssum13);
						echo "<br>a = Jumlah Bobot Untuk Penyakit P13 = $dsum8[j13]";
						...
						//PROSES PENYAKIT P014
                        $s14 = $conn->query("select * from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P14%') AND konsultasi=$konsultasi");
                        ...
                        $ssum14 = $conn->query("select sum(if(a.konsultasi=$konsultasi, a.bobot,0)) as j14
                                                from hasil_konsultasi a where a.id_gejala IN (select b.id_gejala from penyakit_gejala b where b.kode_penyakit like 'P14%')") or die(mysqli_error());
                        ...
                        if($MAX==$proses1){
                            ...
                            $ket = $conn->query("insert into keterangan (id_konsultasi, nama, tgl_konsultasi, nilai, kode_penyakit) values ('$konsultasi', '$dpas[nama]', NOW(), '$MAX', '$dp[kode_penyakit]')");
                        }
                        else if($MAX==$proses2){
